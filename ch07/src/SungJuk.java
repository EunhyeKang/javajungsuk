...
//	double avg;
//	
//	public void inputScore(int kor,int eng){//   성적입력();
//		this.kor = kor;
//		this.eng = eng;
//	}
//	public int totalScore(){//성적합계();
//		return kor+eng;
//	}
//	public double avgScore(){//성적평균();
//		return total/2.0;
//	}
//}
//
...
//class C extends B {
//
//	getGrade(){//  평점구하기(); 단 평점의 종류는 A(100~90점), B(89~80점), C(79~70점), D(69~60점), F(59점 이하)로 정한다.
//		
//	}
//
//	getGradeCount(){//  평점별학생수카운트();
//		
//	}
//
//	drawGraph(){//  가로형막대그래프그리기();
//		
//	}
//}
//
