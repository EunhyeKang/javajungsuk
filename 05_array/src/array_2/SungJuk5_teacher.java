...
public class SungJuk5_teacher {
	public static void main(String[] args) {
		...
		for(int i=0; i<cnt; i++) { //인원수만큼 반복
			...
			subject[i] = new String[subjectCnt]; //과목수만큼 과목명담길방 생성
			...
			jumsu[i] = new int[subjectCnt+1]; //과목수만큼 점수 담길 방 생성 //마지막방은 총점계산방
