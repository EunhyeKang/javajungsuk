...
//		name[0] = new String[stuNum]; //배열방생성
//		sum = new int[stuNum];
...
//			name[0][i] = new Scanner(System.in).nextLine();
//			
//			
//			// 과목수 입력
//			System.out.print("과목수 입력:");
//			subjectCnt = new Scanner(System.in).nextInt();
//			student[0][i] = new String[subjectCnt]; //과목수만큼 방잡아주기//**************
//			
...
//			
//			System.out.print("이름\t ");
//			for(int j=0; j<student[0].length; j++) { //과목명
//				System.out.printf(student[0][j]+"\t");
//			}
